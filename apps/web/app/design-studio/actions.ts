...
export async function generateDesign(form: FormData) { const s = scope(form); await apiRequest(`/workspaces/${s.workspace}/projects/${s.project}/requirements/${s.requirement}/design/artifacts`, designArtifactSchema, { method: "POST", body: {} }); redirect(`${href(s)}&generated=1`); }
